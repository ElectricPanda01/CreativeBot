...
const buy = require('./formats/buy.js')
const sell = require('./formats/sell.js')
const requestroles = require('./formats/requestroles.js')
const showcase = require('./formats/showcase.js')
const request = require('./formats/request.js')
